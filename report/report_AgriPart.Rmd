...
In Fig 4 we can see that SGHMC has the better result than SGD with momentum. Additionally, according to the running time of our experiments, SGHMC is much faster than SGD with momentum. 
